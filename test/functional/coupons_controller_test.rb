...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { expired_at: @coupon.expired_at, sn_code: @coupon.sn_code, status: @coupon.status, used_at: @coupon.used_at }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { expired_at: @coupon.expired_at, sn_code: @coupon.sn_code, status: @coupon.status, used_at: @coupon.used_at }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
